...
const Interests = () => {
  const [interests, setInterests] = useState([
    ...
    { id: 6, name: "sport", status: false },
    { id: 7, name: "movie", status: false },
    { id: 8, name: "games", status: false },
    { id: 9, name: "drinks", status: false },
    { id: 10, name: "social N.", status: false },
    { id: 12, name: "family", status: false },
    { id: 13, name: "pets", status: false },
    { id: 14, name: "politics", status: false },
    { id: 15, name: "dance", status: false },
    { id: 16, name: "bars", status: false },
